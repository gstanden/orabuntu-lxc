...
then
	...
	echo ''
	echo "=============================================="
	echo "Display LXC NTP service status...             "
	echo "=============================================="
	echo ''
	echo "=============================================="
	echo "Note: 'ntp_adjtime() failed' is a known issue "
	echo "Here we just want to see service started ok   "
	echo "=============================================="
	echo ''
	...
	echo ''
	echo "=============================================="
	echo "Displaed LXC NTP service status.              "
	echo "=============================================="
