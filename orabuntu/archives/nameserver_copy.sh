...
sleep 5
sshpass -v -p ubuntu ssh -t -o CheckHostIP=no -o StrictHostKeyChecking=no ubuntu@$MultiHostVar5 "sudo -S <<< "ubuntu" tar -cvzPf $NameServer.tar.gz -T /home/ubuntu/Downloads/orabuntu-lxc-master/orabuntu/archives/nameserver.lst"
