...
echo ''
echo "============================================================"
echo "Patch scst_const.h for Ubuntu $UbuntuRelease                "
echo "============================================================"
echo '' 

if [ $UbuntuRelease = '17.10' ]
then
	sudo sed -i "s/#if LINUX_VERSION_CODE < KERNEL_VERSION(4, 12, 0)/#if LINUX_VERSION_CODE < KERNEL_VERSION(4, 14, 0)/g"	scst-"$VersionString"/scst/include/scst_const.h
	grep 'KERNEL_VERSION(4, 14, 0)' scst-"$VersionString"/scst/include/scst_const.h
fi

echo ''
echo "============================================================"
echo "Completed: Patch scst_const.h for Ubuntu $UbuntuRelease     "
echo "============================================================"
echo ''
...
echo ''
echo "============================================================"
echo "Set Ubuntu $UbuntuRelease gcc/g++ back to v7 default...     "
echo "============================================================"
echo '' 
...
then
	...
	echo ''
	echo "============================================================"
	echo "Create gcc-7/g++-7 alternatives Ubuntu $UbuntuRelease...    "
	echo "============================================================"
	echo '' 
	...
	echo ''
	echo "============================================================"
	echo "Done: Create gcc-7/g++-7 alternatives Ubuntu $UbuntuRelease "
	echo "============================================================"
	echo '' 
	...
	echo ''
	echo "============================================================"
	echo "Show gcc/g++ version Ubuntu $UbuntuRelease...               "
	echo "============================================================"
	echo '' 
	...
	echo ''
	echo "============================================================"
	echo "Done: Show gcc/g++ version Ubuntu $UbuntuRelease.           "
	echo "============================================================"
	echo '' 
fi
...
echo ''
echo "============================================================"
echo "Done: Set Ubuntu $UbuntuRelease gcc/g++ back to v7 default. "
echo "============================================================"
echo '' 
