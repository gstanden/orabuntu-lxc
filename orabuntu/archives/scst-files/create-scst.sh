...
echo "                                                       "
echo "Ubuntu 17.10 artful 	DKMS		kernel 4.13+ "
...
# GLS 20171111 scst-files "standalone" modifcation start
# GLS 20171111 if there are no OpenvSwitches defined set create-scst-oracle.sh to non-multihost values.
...
if [ $TestSw2 -ne 0 ] && [ $TestSw3 -ne 0 ]
then
	echo ''
	echo "======================================================="
	echo "Configure for SCST in Standalone Mode...               "
	echo "======================================================="
	echo ''

	function GetSWITCH_IP {
		grep MultiHost ../../../anylinux/anylinux-services.sh | grep -v '#' | grep ':' | cut -f3 -d':'
	}
	SWITCH_IP=$(GetSWITCH_IP)
	echo 'SWITCH_IP = '$SWITCH_IP
	sudo sed -i "s/SWITCH_IP/$SWITCH_IP/g" create-scst-oracle.sh
	grep SWITCH_IP create-scst-oracle.sh
	
	echo ''
	echo "======================================================="
	echo "Done: Configure for SCST in Standalone Mode.           "
	echo "======================================================="
	echo ''
else
	echo ''
	echo "======================================================="
	echo "Configured for SCST in Orabuntu-LXC mode.              "
	echo "======================================================="
	echo ''
	SWITCH_IP=1
	echo 'SWITCH_IP = '$SWITCH_IP
...
# GLS 20171111 scst-files "standalone" modification end
...
./create-scst-oracle.sh com.urdomain1 lxc1 external 5G 15G 15G
