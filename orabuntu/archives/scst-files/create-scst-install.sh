...
then
	...
	clear
        ...
        echo ''
        echo "======================================================="
        echo "Ubuntu Release is $UbuntuRelease.                      "
        echo "======================================================="
        echo ''
	...
	then
		...
		function GetTrunkVersion {
			grep -R SCST_VERSION_NAME scst/include/scst_const.h | head -1 | cut -f2 -d'"'
		}
		...
		echo ''
		echo "======================================================"
		echo "Checkinstall create/install Deb SCST Package next...  "
		echo "======================================================"
		echo ''
		echo "======================================================"
		...
		echo ''
		echo "======================================================"
		echo "Checkinstall create/install Debian SCST Package...    "
		echo "======================================================"
		echo ''

		sleep 5

		if [ "$UbuntuRelease" = '17.04' ]
		then
			chmod 755 create-scst-dkms.sh
			./create-scst-dkms.sh | tee create-scst-dkms.log
		else
		...
		echo ''
		echo "======================================================"
		echo "Checkinstall Debian SCST Package Complete.            "
		echo "======================================================"
