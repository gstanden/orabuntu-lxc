...
and unzip it, then navigate to the "anylinux" directory. **Note** that you can download to any directory owned by the install user; the "Downloads" directory is just a recommended download destination.
