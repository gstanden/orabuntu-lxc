...
* Note that if an OS is being installed in a VM or on a physical host in preparation for use 
with Orabuntu-LXC both Oracle Linux and Ubuntu Linux OS installers have options for creating 
the install user "ubuntu" with admin sudo privileges.  
...
* Settings are made in the "anylinux-services.sh" file.
...
```
	...
	<b> MultiHost="new:Y:4:$SudoPassword:111.222.333.444:111.222.333.444:1500:ubuntu:ubuntu:$GRE"</b>
	#MultiHost="reinstall:N:1:$SudoPassword:192.168.1.5:192.168.1.68:1500:ubuntu:ubuntu:$GRE"
	#MultiHost="reinstall:Y:7:$SudoPassword:192.168.1.5:192.168.1.10:1420:ubuntu:ubuntu:$GRE"
	#MultiHost="addclones"
 ```
 ...
 ```
 For the 1st VNIC, bridge it to any of the following taps {s2,s3,s4,s5.s6} and set to "Allow All" mode.
 For the 2nd VNIC, bridge it to any of the following taps {a2,a3,a4,a5,a6} and set to "Allow All" mode.
 ```
...
```
        ...
        GRE=Y
        #MultiHost="new:N:1:$SudoPassword:111.222.333.444:111.222.333.444:1500:ubuntu:ubuntu:$GRE"
	<b> MultiHost="new:Y:5:$SudoPassword:HUB.host.lan.ip:GRE.host.lan.ip:1420:ubuntu:ubuntu:$GRE"</b>
	#MultiHost="reinstall:N:1:$SudoPassword:192.168.1.5:192.168.1.68:1500:ubuntu:ubuntu:$GRE"
	#MultiHost="reinstall:Y:7:$SudoPassword:192.168.1.5:192.168.1.10:1420:ubuntu:ubuntu:$GRE"
	#MultiHost="addclones"
 ```
