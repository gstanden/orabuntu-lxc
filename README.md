...
The Orabuntu-LXC development branch now supports putting your Oracle VirtualBox VM's on the Orabuntu-LXC OpenvSwitch network on the physical host, for both Ubuntu Linux 16.x and 17.x physical hosts, and also for Oracle Linux 7.x physical hosts.  This update supercedes note 1 below from the December 2, 2017 update, and expands this new feature to both Ubuntu 17.10 server-edition and desktop-edition VMs and Oracle Linux 7 VMs.  It "should" also work for Ubuntu 17.x and 16.x VMs (but only 17.10 VMs and Oracle Linux 7 VMs have been tested so far).
