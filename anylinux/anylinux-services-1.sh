...
then
	...
	then
		...
		then
			...
			echo ''
			echo "=============================================="
			echo "   !! WARNING ABOUT INSTALLS ON VM'S !!       "
		        echo "                                              "
			echo " Installs on VM's have had MIXED results.     "
			echo "Orabuntu-LXC installs fine but reboots can be "
			echo "very problematic sometimes it works ok or     "
			echo "sometimes the VM can even fail to reboot.     "
			echo "Test the install in a VM that is dedicated to "
			echo "testing Orabuntu-LXC first before installing  "
			echo "on an mission-critical VM.                    "
			echo "=============================================="
			echo ''
			echo "=============================================="
			echo " INSTALLS ON BARE METAL WORK GREAT NO ISSUES  "
			echo " BASED ON ALL TESTS RUN SO FAR.  THIS SOFTWARE"
			echo " IS BASICALLY INTENDED FOR BARE METAL INSTALLS"
			echo "=============================================="
			echo ''
			echo "=============================================="
