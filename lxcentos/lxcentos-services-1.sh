...
if [ -f /etc/orabuntu-lxc-release ] && [ $Operation = 'reinstall' ]
then
	...
	then
		...
		# GL@ 20170925 Ubuntu Linux OVS and LXC are build from packages.  This step is not necessary on Ubuntu Linux.
		...
		echo ''
		echo "=============================================="
		echo "Uinstall lxc packages completed.              "
		echo "=============================================="
		echo ''	
		echo "=============================================="
...
then
	...
	sudo iptables -I INPUT -i lxcbr0 -p udp --dport 67 -j ACCEPT
	sudo iptables -I INPUT -i lxcbr0 -p tcp --dport 67 -j ACCEPT
	sudo iptables -I INPUT -i lxcbr0 -p tcp --dport 53 -j ACCEPT
	sudo iptables -I INPUT -i lxcbr0 -p udp --dport 53 -j ACCEPT
...
then
	...
	echo ''
	echo "=============================================="
	echo "Done: Upgrade LXC from Source.                "
	echo "=============================================="
...
sudo yum -y install iptables gawk
...
then
	...
	sudo /etc/network/openvswitch/lxc-net
