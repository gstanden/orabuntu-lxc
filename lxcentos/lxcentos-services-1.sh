...
echo ''
echo "=============================================="
echo "Script:  lxcentos-services-1.sh               "
echo "=============================================="
...
then
	...
	then
		...
		if [ $? -ne 0 ]
			...
			sudo yum -y install lxc lxc-templates lxc-extras dnsmasq bridge-utils iptables-services debootstrap perl libvirt

			sudo sh -c "echo '[Unit]'							>  /etc/systemd/system/lxc-net.service"
			sudo sh -c "echo 'Description=lxc-net Service'					>> /etc/systemd/system/lxc-net.service"
			sudo sh -c "echo ''								>> /etc/systemd/system/lxc-net.service"
			sudo sh -c "echo '[Service]'							>> /etc/systemd/system/lxc-net.service"
			sudo sh -c "echo 'Type=oneshot'							>> /etc/systemd/system/lxc-net.service"
			sudo sh -c "echo ''								>> /etc/systemd/system/lxc-net.service"
			sudo sh -c "echo 'ExecStart=/sbin/brctl addbr lxcbr0'				>> /etc/systemd/system/lxc-net.service"
			sudo sh -c "echo 'ExecStart=/sbin/ip address add 10.0.3.1/24 dev lxcbr0'	>> /etc/systemd/system/lxc-net.service"
			sudo sh -c "echo 'ExecStart=/sbin/ip link set lxcbr0 up'			>> /etc/systemd/system/lxc-net.service"
			sudo sh -c "echo ''								>> /etc/systemd/system/lxc-net.service"
			sudo sh -c "echo 'RemainAfterExit=yes'						>> /etc/systemd/system/lxc-net.service"
			sudo sh -c "echo ''								>> /etc/systemd/system/lxc-net.service"
			sudo sh -c "echo 'ExecStop=/sbin/ip link set lxcbr0 down'			>> /etc/systemd/system/lxc-net.service"
			sudo sh -c "echo 'ExecStop=/sbin/brctl delbr lxcbr0'				>> /etc/systemd/system/lxc-net.service"
			sudo sh -c "echo ''								>> /etc/systemd/system/lxc-net.service"
                        sudo sh -c "echo '[Install]'                                                    >> /etc/systemd/system/lxc-net.service"
                        sudo sh -c "echo 'WantedBy=multi-user.target'                                   >> /etc/systemd/system/lxc-net.service"

			sudo sh -c "echo '[Unit]'							>  /etc/systemd/system/lxc-dhcp.service"
			sudo sh -c "echo 'Description=lxc-dhcp Service'				 	>> /etc/systemd/system/lxc-dhcp.service"
			sudo sh -c "echo 'Requires=lxc-net.service'					>> /etc/systemd/system/lxc-dhcp.service"
			sudo sh -c "echo 'Requires=sys-devices-virtual-net-lxcbr0.device'		>> /etc/systemd/system/lxc-dhcp.service"
			sudo sh -c "echo 'After=sys-devices-virtual-net-lxcbr0.device'			>> /etc/systemd/system/lxc-dhcp.service"
			sudo sh -c "echo ''								>> /etc/systemd/system/lxc-dhcp.service"
			sudo sh -c "echo '[Service]'							>> /etc/systemd/system/lxc-dhcp.service"
			sudo sh -c "echo 'ExecStart=/sbin/dnsmasq \'					>> /etc/systemd/system/lxc-dhcp.service"
			sudo sh -c "echo '            --dhcp-leasefile=/var/run/lxc-dnsmasq.leases \'	>> /etc/systemd/system/lxc-dhcp.service"
			sudo sh -c "echo '            --user=nobody \'					>> /etc/systemd/system/lxc-dhcp.service"
			sudo sh -c "echo '            --group=nobody \'					>> /etc/systemd/system/lxc-dhcp.service"
			sudo sh -c "echo '            --keep-in-foreground \'				>> /etc/systemd/system/lxc-dhcp.service"
			sudo sh -c "echo '            --listen-address=10.0.3.1 \'			>> /etc/systemd/system/lxc-dhcp.service"
			sudo sh -c "echo '            --except-interface=lo \'				>> /etc/systemd/system/lxc-dhcp.service"
			sudo sh -c "echo '            --bind-interfaces \'				>> /etc/systemd/system/lxc-dhcp.service"
			sudo sh -c "echo '            --dhcp-range=10.0.3.2,10.0.3.254'			>> /etc/systemd/system/lxc-dhcp.service"
			sudo sh -c "echo ''								>> /etc/systemd/system/lxc-dhcp.service"
			sudo sh -c "echo '[Install]'							>> /etc/systemd/system/lxc-dhcp.service"
			sudo sh -c "echo 'WantedBy=default.target'					>> /etc/systemd/system/lxc-dhcp.service"
			...
			sudo chmod +x /etc/network/openvswitch/lxc-net && sudo /etc/network/openvswitch/lxc-net
	...
	then
		...
		echo ''
		echo "=============================================="
		echo "Upgrade LXC from Source on CentOS Linux...    "
		echo "=============================================="
		...
		function GetLXCPackageCount {
			sudo rpm -qa | grep lxc | egrep -c '2.0.5|libvirt-daemon-driver-lxc'
		}
...
then
	...
	do
		...
		cp -p openvswitch-2.5.1.tar.gz /home/ubuntu/Downloads/orabuntu-lxc-master/lxcentos/openvswitch/rpmbuild/SOURCES/.
		...
		cp -p openvswitch-2.5.1/rhel/*.spec /home/ubuntu/Downloads/orabuntu-lxc-master/lxcentos/openvswitch/.
		cd /home/ubuntu/Downloads/orabuntu-lxc-master/lxcentos/openvswitch
...
sudo cat /etc/redhat-release | cut -f4 -d' ' | cut -f1 -d'.'
}
...
echo ''
echo "=============================================="
echo "Unpacking G1 host files for CentOS Linux...   "
echo "=============================================="
echo ''
...
echo ''
echo "=============================================="
echo "G1 host files for CentOS Linux unpacked.      "
echo "=============================================="
...
echo ''
echo "=============================================="
echo "Unpacking G2 host files for CentOS Linux...   "
echo "=============================================="
echo ''
...
echo ''
echo "=============================================="
echo "G2 host files for CentOS Linux unpacked.      "
echo "=============================================="
...
echo ''
echo "=============================================="
echo "Custom files for CentOS Linux installed.      "
echo "=============================================="
...
then
	...
	nslookup $NameServer > /dev/null 2>&1
	while [ $? -ne 0 ]
	do
		nslookup $NameServer > /dev/null 2>&1
	done
...
echo "=============================================="
echo "Next script to run: lxcentos-services-2.sh    "
echo "=============================================="
