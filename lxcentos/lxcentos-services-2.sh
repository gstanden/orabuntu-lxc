...
echo ''
echo "=============================================="
echo "lxcentos-services-2.sh script                   "
echo "                                              "
...
echo ''
echo "=============================================="
echo "Verify /etc/resolv.conf fil ...               "
echo "=============================================="
echo ''
...
echo ''
echo "=============================================="
echo "Verified /etc/resolv.conf file.               "
echo "=============================================="
...
echo ''
echo "=============================================="
echo "Install package for LXC oracle container...   "
echo "=============================================="
echo ''

sudo yum -y install redhat-lsb-core redhat-lsb 

echo ''
echo "=============================================="
echo "Installed package for LXC oracle container... "
echo "=============================================="
...
echo ''
echo "==============================================" 
echo "Next script to run: lxcentos-services-3.sh    "
echo "=============================================="
