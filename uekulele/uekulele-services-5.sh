...
then
	...
	echo ''
        ...
        sudo sh -c "echo 'Orabuntu-LXC v7.0.0-alpha ELENA' > /etc/orabuntu-lxc-release"
	...
	then
	        ...
	        sshpass -p ubuntu ssh -t -o CheckHostIP=no -o StrictHostKeyChecking=no ubuntu@10.207.39.2 "sudo -S <<< "ubuntu" service bind9 restart"
	...
	then
	        ...
	        sshpass -p ubuntu ssh -t -o CheckHostIP=no -o StrictHostKeyChecking=no ubuntu@10.207.29.2 "sudo -S <<< "ubuntu" service bind9 restart"
