...
function GetVersionString {
        cat scst-*/usr/include/version.h | grep VERSION_STR | cut -f2 -d'"' | cut -f1 -d'-'
}
VersionString=$(GetVersionString)

if [ -d scst-"$VersionString" ]
then
	sudo mv scst-"$VersionString" scst-latest
fi
...
rm -rf master.zip create-scst-dkms.log multipath.con
...
echo "=============================================="
echo "               !! WARNING !!                  "
echo "THIS STEP DESTROYS THE SCST SAN CONFIGURATION!"
echo " IF ANY DOUBTS PRESS <ctrl>+C NOW TO REVIEW!  "
...
echo ''
echo "=============================================="
echo "Uninstall SCST: SCST configuration removed.   "
echo "=============================================="
...
echo ''
echo "=============================================="
echo "sudo apt-get purge (scst dkms modules)...     "
echo "=============================================="
echo ''
...
echo ''
echo "=============================================="
echo "sudo rm -rf /usr/src/scst-"$VersionString"/iscsi-scst    "
echo "=============================================="
echo ''

sudo rm -rf /usr/src/scst-"$VersionString"/iscsi-scst
sudo rm -rf master.zip create-scst-dkms.log multipath.conf

echo ''
echo "=============================================="
echo "Uninstall SCST: DKMS modules uninstalled.     "
echo "=============================================="
...
echo ''
echo "=============================================="
echo "sudo dkms status | grep scst (no output)      "
echo "=============================================="
echo ''
...
echo ''
echo "=============================================="
echo "Uninstall SCST: Confirm DKMS modules removed. "
echo "=============================================="
...
echo ''
echo "=============================================="
echo "sudo dpkg -l | grep scst (no output)          "
echo "=============================================="
echo ''
...
echo ''
echo "=============================================="
echo "Uninstall SCST: Confirm SCST Packages removed."
echo "=============================================="
...
echo ''
echo "=============================================="
echo "Uninstall SCST: LUN backing-files removed.    "
echo "=============================================="
...
then
	...
	echo ''
	echo "=============================================="
	echo "Uninstall SCST: Service uekuscst removed.     "
	echo "=============================================="
	...
	echo ''
	echo "=============================================="
	echo "sudo systemctl disable scst-san               "
	echo "=============================================="
	echo ''

	sudo systemctl disable scst-san
	sudo rm -f /etc/systemd/system/scst-san

	echo ''
	echo "=============================================="
	echo "Uninstall SCST: Service scst-san removed.     "
	echo "=============================================="
...
echo ''
echo "=============================================="
echo "Uninstall SCST: UDEV 99-oracle.rules emoved.  "
echo "=============================================="
...
echo ''
echo "=============================================="
echo "sudo sed -i '/scst-module/d' /etc/modules     "
echo "=============================================="
echo ''

sudo sed -i '/iscsi-scst/d'	/etc/modules
sudo sed -i '/scst_vdisk/d'	/etc/modules
sudo sed -i '/scst_disk/d'	/etc/modules
sudo sed -i '/scst_user/d'	/etc/modules
sudo sed -i '/scst_modisk/d'	/etc/modules
sudo sed -i '/scst_processor/d'	/etc/modules
sudo sed -i '/scst_raid/d'	/etc/modules
sudo sed -i '/scst_tape/d'	/etc/modules
sudo sed -i '/scst_cdrom/d'	/etc/modules
sudo sed -i '/scst_changer/d'	/etc/modules

cat /etc/modules

echo ''
echo "=============================================="
echo "Uninstall SCST: /etc/modules cleaned.         "
echo "=============================================="
...
echo "=============================================="
echo "                                              "
read -e -p "rm directory scst-latest source [Y/N]    " -i "N" DeleteTrunkSCST
echo "                                              "
echo "=============================================="
echo ''
