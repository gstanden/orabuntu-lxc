...
then
	...
	DevNode=$(GetDevNode)
        ...
        if [ -f 99-oracle.rules ]
        then
                sudo rm 99-oracle.rules
        fi
	...
	do
		...
		do
			...
			then
				...
				echo "     }" >> multipath.conf
				cp -p 99-oracle.rules.template 99-oracle.rules.$wwid.$i
				sed -i "s/wwid/$wwid/g" 				99-oracle.rules.$wwid.$i
				sed -i "s/FriendlyName/$i/g" 				99-oracle.rules.$wwid.$i
				sed -i "s/ContainerName/$ContainerName/g"		99-oracle.rules.$wwid.$i
				sed -i "s/Owner/$Owner/g"				99-oracle.rules.$wwid.$i
				sed -i "s/Group/$Group/g"				99-oracle.rules.$wwid.$i
				sed -i "s/Mode/$Mode/g"					99-oracle.rules.$wwid.$i
				cat 99-oracle.rules.$wwid.$i >> 99-oracle.rules
			fi
		done
	done
	echo '}' >> multipath.conf
	...
	then
	sudo cp -p /etc/multipath.conf /etc/multipath.conf.pre-scst.bak
	fi
	...
	echo ''
	echo "===================================================="
	echo "Install 99-oracle.rules file (backup old first)...   "
	echo "===================================================="

	if [ -f /etc/udev/rules.d/99-oracle.rules ]
	then
		sudo cp -p /etc/udev/rules.d/99-oracle.rules /etc/udev/rules.d/99-oracle.rules.pre-scst.bak
		sudo cat 99-oracle.rules /etc/udev/rules.d/99-oracle.rules > new
		sudo mv new 99-oracle.rules
	else
		sudo cp -p 99-oracle.rules /etc/udev/rules.d/99-oracle.rules
		sudo chmod 755 /etc/udev/rules.d/99-oracle.rules
	fi
	...
	echo ''
	echo "===================================================="
	echo "Install 99-oracle.rules file completed.             "
	echo "===================================================="
	...
	echo ''
	echo "===================================================="
	echo "Verify SCST SAN:  ls -l /dev/mapper/asm             "
	echo "===================================================="
	echo ''
	...
	echo ''
	echo "===================================================="
	echo "Verify SCST SAN: sudo ls-l /dev/dm* (grid:asmadmin) " 
	echo "===================================================="
	echo ''
	...
	echo ''
	echo "===================================================="
	echo "Verify SAN: cat /etc/udev/rules.d/99-oracle.rules   "
	echo "===================================================="
	echo ''
...
then
	...
	echo ''
	echo "===================================================="
	echo "Verify SCST SAN: LUNS using multipath.conf aliases. "
	echo "===================================================="
	...
	echo ''
	echo "===================================================="
	echo "Verify SCST SAN: (owner:group) = (grid:asmadmin)    "
	echo "===================================================="
	...
	echo ''
	echo "===================================================="
	echo "Verify SCST: cat /etc/udev/rules.d/99-oracle.rules  "
	echo "===================================================="
	echo ''
	...
	echo ''
	echo "===================================================="
	echo "Verify SCST SAN: Set owner:group of Oracle LUNS     "
	echo "===================================================="
fi
